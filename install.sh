...
DOTFILES_WALLPAPERS_DIRECTORY_NAME=${DOTFILES_DIRECTORY_NAME}'/wallpapers'
DOTFILES_CONFIG_DIRECTORY_NAME=${DOTFILES_DIRECTORY_NAME}'/.config'
...
InstallWallpapers () {
  ...
  CopyTo $DOTFILES_WALLPAPERS_DIRECTORY_NAME $DEFAULT_WALLPAPERS_PATH
}

InstallDotfiles () {
  CreateDirectory $DEFAULT_CONFIG_PATH
  CopyTo $DOTFILES_CONFIG_DIRECTORY_NAME $DEFAULT_CONFIG_PATH
}
